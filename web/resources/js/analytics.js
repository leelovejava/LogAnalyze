(function () {
    ...
    var tracker = {
        ...
        /**
         * 触发launch事件(当用户第一次访问网站的时候触发该事件，不提供对外调用的接口，只实现该事件的数据收集)
         */
        onLaunch: function () {
            var launch = {};
        ...
        /**
         * 触发page view事件(当用户访问页面/刷新页面的时候触发该事件)
         */
        onPageView: function () {
            if (this.preCallApi()) {
        ...
        /**
         * 触发订单产生事件(当用户下订单的时候触发该事件，该事件需要程序主动调用)
         * @param orderId 订单id
         * @param name 产品购买描述名称
         * @param currencyAmount 订单价格
        ...
        /**
         *  触发event事件(当访客/用户触发业务定义的事件后)
         * @param category 自定义事件的Category名称
