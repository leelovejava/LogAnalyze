...
from (
  ...
  where 
    ...
    and pl is not null 
    and s_time >= unix_timestamp('2019-03-22','yyyy-MM-dd')*1000 
    and s_time < unix_timestamp('2019-03-23','yyyy-MM-dd')*1000
  group by 
...
select 2,1,6,sum(pv1),sum(pv2),sum(pv3),sum(pv4),sum(pv5_10),sum(pv10_30),sum(pv30_60),sum(pv60_plus),'2017-01-10' group by pl,date1;
